...
'''
NOTE Copied from: https://github.com/HeliosZhao/ControlNet-Stable-UnCLIP/blob/main/controlnet/pipeline/pipeline_sdcontrolnet_unclip.py
...
from diffusers.utils import is_accelerate_version, logging, replace_example_docstring, PIL_INTERPOLATION
